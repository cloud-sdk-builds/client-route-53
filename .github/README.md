...
[`@aws-sdk/client-route-53`](https://www.npmjs.com/package/@aws-sdk/client-route-53/v/3.654.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route-53@3.654.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mHdo+91Jar+LchXsuQsqF9RvNPzsM3VgHc5n13vOxD6rm0ierpPAlk0WzocU7+Js
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route-53": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route-53@3.654.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route-53@3.654.0/index.min.mjs": "sha384-mHdo+91Jar+LchXsuQsqF9RvNPzsM3VgHc5n13vOxD6rm0ierpPAlk0WzocU7+Js"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route-53/blob/refs/tags/3.654.0/LICENSE
```
